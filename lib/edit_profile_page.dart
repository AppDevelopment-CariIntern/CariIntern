...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (_imageFile != null) {
        // Explicitly using the class from the firebase_storage package
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Profile', style: TextStyle(color: Color(0xFF311B92), fontWeight: FontWeight.bold)),
